...
(function (angular) {
	...
	// Alternate list
	'elvis.header', 'elvis.results', 'elvis.reviewing',
	//'icsm.list',
	'icsm.mapevents', 'icsm.select', 'icsm.state', 'icsm.templates', 'icsm.view'])
...
(function (angular) {
   ...
   angular.module("icsm.list", []).directive('icsmList', ['$rootScope', 'listService', function ($rootScope, listService) {
      return {
...
(function (angular) {
    ...
    angular.module("elvis.results", ['elvis.results.continue']).directive('icsmList', ['$rootScope', 'listService', function ($rootScope, listService) {
        return {
...
(function (angular) {
   ...
   angular.module("elvis.reviewing", []).directive('icsmReview', ['$rootScope', '$uibModal', '$log', 'reviewService', function ($rootScope, $uibModal, $log, reviewService) {
      ...
      return {
         template: '<div class="input-group">' + '<span class="input-group-addon" id="nedf-email">Email</span>' + '<input required="required" type="email" ng-change="changeEmail(email)" ng-model="email" class="form-control" placeholder="Email address to send download link" aria-describedby="nedf-email">' + '</div>',
         restrict: "AE",
         link: function link(scope, element) {
...
$templateCache.put("icsm/results/continue.html","<div class=\"continue-container\" ng-show=\"ctrl.products | someSelected\">\r\n   <button class=\"btn btn-default\" ng-click=\"ctrl.review()\">Review and download {{ctrl.selected.length}} selected datasets</button>\r\n</div>\r\n\r\n");
