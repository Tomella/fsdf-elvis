      ...
      var Service = function () {
         ...
         _createClass(Service, [{
            ...
            get: function get() {
               ...
               return this.hasValidBbox() ? { bounds: this.bounds, metadata: this.metadata, polygon: this.polygon } : null;
            }
         }, {
            key: "metadata",
            get: function get() {
      ...
      return {
         ...
         link: function link(scope) {
            ...
            mapService.getMap().then(function (map) {
               ...
               scope.control = L.Control.elevationControl({ handler: handler }).addTo(map);
               ...
               searching: function searching(latlng) {
                  ...
                  elevationPointsService.getHiResElevation(latlng).then(function (response) {
                     ...
                     */
                     ...
                     L.popup({ maxWidth: 400 }).setLatLng(latlng).setContent("<div class='fi-popup'>" + buffer.join("<br/>") + "</div>").openOn(map);
...
var EftfStrategy = function (_BaseStrategy4) {
   _inherits(EftfStrategy, _BaseStrategy4);

   function EftfStrategy(http) {
      _classCallCheck(this, EftfStrategy);

      return _possibleConstructorReturn(this, (EftfStrategy.__proto__ || Object.getPrototypeOf(EftfStrategy)).call(this, http));
   }
...
var NswStrategy = function (_BaseStrategy5) {
   _inherits(NswStrategy, _BaseStrategy5);

   function NswStrategy(http) {
      _classCallCheck(this, NswStrategy);

      var _this6 = _possibleConstructorReturn(this, (NswStrategy.__proto__ || Object.getPrototypeOf(NswStrategy)).call(this, http));

      _this6.NSW_METADATA_TEMPLATE = "https://s3-ap-southeast-2.amazonaws.com/nsw.elvis/z5${zone}/Metadata/";
      return _this6;
   }
   ...
   _createClass(NswStrategy, [{
      ...
      value: function requestMetadata(item) {
         ...
         return this.http.get(url).then(function (response) {
            ...
            return {
               title: _get(NswStrategy.prototype.__proto__ || Object.getPrototypeOf(NswStrategy.prototype), 'NO_METADATA', _this7)
            };
         });
      }
   }]);
...
var NtStrategy = function (_BaseStrategy6) {
...
var QldStrategy = function (_BaseStrategy7) {
   _inherits(QldStrategy, _BaseStrategy7);

   function QldStrategy(http) {
      _classCallCheck(this, QldStrategy);

      var _this9 = _possibleConstructorReturn(this, (QldStrategy.__proto__ || Object.getPrototypeOf(QldStrategy)).call(this, http));

      _this9.XML_METADATA_TEMPLATE = "http://qldspatial.information.qld.gov.au/catalogue/rest/document?id={metadata_id}&f=xml";
      _this9.QLD_METADATA_TEMPLATE = "http://qldspatial.information.qld.gov.au/catalogue/rest/document?id={EB442CAB-D714-40D8-82C2-A01CA4661324}&f=xml";
      _this9.QLD_HTML_TEMPLATE = "http://qldspatial.information.qld.gov.au/catalogue/custom/detail.page?fid={EB442CAB-D714-40D8-82C2-A01CA4661324}";
      _this9.FRASER_COAST_METADATA_TEMPLATE = "http://qldspatial.information.qld.gov.au/catalogue/rest/document?id={E8CEF5BA-A1B7-4DE5-A703-8161FD9BD3CF}&f=xml";
      _this9.FRASER_COAST_HTML_TEMPLATE = "http://qldspatial.information.qld.gov.au/catalogue/custom/detail.page?fid={E8CEF5BA-A1B7-4DE5-A703-8161FD9BD3CF}";
      _this9.FRASER_COAST_BOUNDS = [152.331, -26.003, 153.370, -24.692]; //  Extracted from metadata XML
   ...
   _createClass(QldStrategy, [{
      ...
      value: function requestMetadata(item) {
         ...
         return this.http.get("xml2js/" + url).then(function (response) {
            ...
            return {
               title: _get(QldStrategy.prototype.__proto__ || Object.getPrototypeOf(QldStrategy.prototype), 'NO_METADATA', _this10)
            };
         });
      }
   }]);
...
var SaStrategy = function (_BaseStrategy8) {
...
var TasStrategy = function (_BaseStrategy9) {
...
var VicStrategy = function (_BaseStrategy10) {
...
var WaStrategy = function (_BaseStrategy11) {
