...
(function (angular) {
	...
	'geo.draw', 'geo.elevation', 'geo.geosearch', 'geo.map', 'geo.maphelper', 'geo.measure', 'icsm.bounds', 'icsm.clip', 'icsm.glossary', 'icsm.help', 'icsm.panes',
	// Alternate list
...
(function (angular) {
    ...
    .directive('icsmAbstractLink', ['$timeout', 'listService', function ($timeout, listService) {
        ...
        var NSW_METADATA_TEMPLATE = "xml2js/https://s3-ap-southeast-2.amazonaws.com/nsw.elvis/z5${zone}/Metadata/";
        ...
        function requestMetadata(filename) {
            ...
            return $http.get(url).then(function (response) {
                ...
                node = node && node.citation && node.citation && node.citation.CI_Citation;
