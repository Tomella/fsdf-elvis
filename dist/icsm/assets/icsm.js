...

{
				...
				'geo.draw', 'geo.elevation', 'geo.geosearch', 'geo.map', 'geo.maphelper', 'geo.measure', 'placenames.search', 'placenames.config', 'placenames.summary', 'icsm.bounds', 'icsm.contributors', 'icsm.coverage', 'icsm.clip', 'icsm.elevation.point', 'icsm.glossary', 'icsm.help', 'icsm.panes', 'icsm.products', "icsm.side-panel",
				// Alternate list
				...
				.config(['configServiceProvider', 'placenamesConfigServiceProvider', 'projectsServiceProvider', 'persistServiceProvider', 'versionServiceProvider', 'elevationPointServiceProvider', function (configServiceProvider, placenamesConfigServiceProvider, projectsServiceProvider, persistServiceProvider, versionServiceProvider, elevationPointServiceProvider) {
