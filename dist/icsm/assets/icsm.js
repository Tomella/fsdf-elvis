...
(function (angular) {
	...
	'geo.draw', 'geo.geosearch', 'geo.map', 'geo.maphelper', 'geo.measure', 'icsm.bounds', 'icsm.clip', 'icsm.glossary', 'icsm.help', 'icsm.panes',
	// Alternate list
	'elvis.header', 'elvis.results', 'elvis.reviewing', 'icsm.mapevents', 'icsm.select', 'icsm.state', 'icsm.templates', 'icsm.view'])
...
(function (angular) {
        ...
        return {
            ...
            link: function link(scope) {
                ...
                function load() {
                    if (!scope.fetched) {
                        scope.fetched = true;
                        listService.getMetadata(scope.item.file_name).then(function (data) {
    ...
    .directive('icsmAbstractHover', ['$timeout', 'listService', function ($timeout, listService) {
        ...
        var METADATA_URL = "nswAbstract/";
        var NO_METADATA = "No metadata found for this dataset.";
...
$templateCache.put("icsm/results/abstractbutton.html","<button type=\"button\" class=\"undecorated\" title=\"View Full title and abstract of this dataset\" ng-click=\"toggle()\">\r\n	<i class=\"fa fa-lg\" ng-class=\"{\'fa-caret-down active\':item.showAbstract, \'fa-caret-right\':!item.showAbstract}\"></i>\r\n</button>");
$templateCache.put("icsm/results/abstracttooltip.html","<span ng-show=\"!item.metadata\">\r\n   {{item.metadata.title}} - {{item.metadata.abstractText}}\r\n</span>\r\n<div ng-show=\"item.metadata.abstract != null\">\r\n   <div ng-show=\"item.metadata.abstract\">\r\n      {{item.metadata.title}} -\r\n      <span class=\"icsm-abstract-body\" ng-bind-html=\"item.metadata.abstractText\"></span >\r\n   </div>\r\n   <div ng-show=\"item.metadata.abstract == null\">\r\n      <i class=\"fa fa-3x fa-exclamation-triangle\" style=\"color:orange\"></i>\r\n      There is no abstract available for this dataset.\r\n   </div>\r\n</div>");
