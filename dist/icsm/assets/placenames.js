...
(function (angular) {
   ...
   angular.module("placenames.search", []).directive('placenamesOptions', ['placenamesSearchService', function (placenamesSearchService) {
      return {
         link: function link(scope) {
