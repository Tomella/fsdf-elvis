var config = {
   ...
   elevation: {
      ...
      useElvis: true,
      elvisTemplate: "https://elvis2018-ga.fmecloud.com/fmejobsubmitter/fsdf_elvis_prod/DEMClipZipShip_Master_S3Source.fmw?geocat_number=${id}&out_grid_name=${filename}&polygon=${polygon}&output_format=${outFormat}&out_coord_sys=${outCoordSys}&industry=${industry}&email_address=${email}&opt_showresult=false&opt_servicemode=async&opt_responseformat=json",
