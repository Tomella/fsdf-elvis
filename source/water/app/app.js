(function (angular) {
	...
	angular.module("WaterApp", [
      ...
      'explorer.message',
		...
		'exp.search.geosearch',
		'exp.search.searches',
		'exp.search.lastsearch',
		'exp.search.templates',
      ...
      'water.select',
		...
		.config(['configServiceProvider', 'projectsServiceProvider', 'versionServiceProvider', 'lastSearchServiceProvider',
         function (configServiceProvider, projectsServiceProvider, versionServiceProvider, lastSearchServiceProvider) {
