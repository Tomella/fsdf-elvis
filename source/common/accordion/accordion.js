angular.module('common.accordion', ['ui.bootstrap.collapse'])

.constant('commonAccordionConfig', {
  closeOthers: true
})
...
.directive('commonAccordionTransclude', function() {
  return {
    ...
    link: function(scope, element, attrs, controller) {
      scope.$watch(function() { return controller[attrs.commonAccordionTransclude]; }, function(heading) {
        if (heading) {
  ...
  function getHeaderSelectors() {
      return 'common-accordion-header,' +
          'data-common-accordion-header,' +
          'x-common-accordion-header,' +
